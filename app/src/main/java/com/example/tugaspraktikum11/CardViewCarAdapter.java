...
public class CardViewCarAdapter extends RecyclerView.Adapter<CardViewCarAdapter.CardViewViewHolder>{
    private ArrayList<Car> listHero;

    public CardViewCarAdapter(ArrayList<Car> list) {
        this.listHero = list;
    }

    @NonNull
    @Override
    public CardViewCarAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_cardview_car, parent, false);
        return new CardViewViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CardViewCarAdapter.CardViewViewHolder holder, int position) {
        Car hero = listHero.get(position);
